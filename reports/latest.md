...
生成时间：`2026-09-24T05:13:57+00:00`
发布闸门：**PASS**
...
剔除条数：`7015`（父域已在代理分类中的子域不再 REJECT）
...
- `DOMAIN-SUFFIX,123hmdhjg2.dyndns.org` ← covered by `None`
...
- `DOMAIN-SUFFIX,456vdghgj30.dyndns.org` ← covered by `None`
...
- `DOMAIN-SUFFIX,5fm.985fm.ca` ← covered by `None`
...
- `DOMAIN-SUFFIX,notary-submissions-prod.s3.us-west-2.amazonaws.com`：`developer/developer` → `streaming/netflix`
...
- `DOMAIN-SUFFIX,adcdownload.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,cdn-cn1.apple-mapkit.com`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,cdn-cn2.apple-mapkit.com`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,cdn-cn3.apple-mapkit.com`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,cdn-cn4.apple-mapkit.com`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,cdn.apple-mapkit.com`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,cdn1.apple-mapkit.com`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,cdn2.apple-mapkit.com`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,cdn3.apple-mapkit.com`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,cdn4.apple-mapkit.com`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,cds.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,clientflow.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,configuration.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,download.developer.apple.com`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,init-p01md-lb.push-apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,init-p01st-lb.push-apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,init-s01st-lb.push-apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,mesu-cdn.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,mesu-china.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,stocks-sparkline-lb.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,store.storeimages.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,swcatalog-cdn.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,swdist.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,swscan-cdn.apple.com.akadns.net`：`service/apple` → `developer/developer`
- `DOMAIN-SUFFIX,weather-data.apple.com.akadns.net`：`service/apple` → `developer/developer`
...
- `DOMAIN,apple.com.akadns.net`：`global/proxy` → `developer/developer`

## 跨分类冲突（最多 100 条）

- `DOMAIN,img-prod-cms-rt-microsoft-com.akamaized.net` → 胜出 `gaming`；涉及 gaming, service
- `DOMAIN-SUFFIX,003store.com` → 胜出 `reject`；涉及 china, reject
- `DOMAIN-SUFFIX,100classicbooks.com` → 胜出 `gaming`；涉及 gaming, global
- `DOMAIN-SUFFIX,11222.com` → 胜出 `china`；涉及 china, global
- `DOMAIN-SUFFIX,165tchuang.com` → 胜出 `reject`；涉及 china, reject
- `DOMAIN-SUFFIX,17gouwuba.com` → 胜出 `reject`；涉及 china, reject
- `DOMAIN-SUFFIX,17swan.com` → 胜出 `china`；涉及 china, service
- `DOMAIN-SUFFIX,198game.com` → 胜出 `china`；涉及 china, global
...
- `DOMAIN-SUFFIX,360.com` → 胜出 `china`；涉及 china, global
...
- `DOMAIN-SUFFIX,37swan.com` → 胜出 `china`；涉及 china, service
...
- `DOMAIN-SUFFIX,5684t.net` → 胜出 `china`；涉及 china, global
- `DOMAIN-SUFFIX,57573zubo36833.com` → 胜出 `reject`；涉及 china, reject
- `DOMAIN-SUFFIX,58pic.com` → 胜出 `china`；涉及 china, global
...
- `DOMAIN-SUFFIX,61draw.com` → 胜出 `china`；涉及 china, global
...
- `DOMAIN-SUFFIX,91.com` → 胜出 `china`；涉及 china, service
- `DOMAIN-SUFFIX,91cy.app` → 胜出 `china`；涉及 china, global
- `DOMAIN-SUFFIX,91short.com` → 胜出 `china`；涉及 china, global
...
- `DOMAIN-SUFFIX,99thz.com` → 胜出 `china`；涉及 china, global
- `DOMAIN-SUFFIX,9cao9.com` → 胜出 `china`；涉及 china, global
- `DOMAIN-SUFFIX,9ht.com` → 胜出 `china`；涉及 china, global
- `DOMAIN-SUFFIX,a1.mzstatic.com` → 胜出 `china`；涉及 china, service
- `DOMAIN-SUFFIX,a2.mzstatic.com` → 胜出 `china`；涉及 china, service
- `DOMAIN-SUFFIX,a2z.com` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,a3.mzstatic.com` → 胜出 `china`；涉及 china, service
- `DOMAIN-SUFFIX,a4.mzstatic.com` → 胜出 `china`；涉及 china, service
- `DOMAIN-SUFFIX,a4xvv2g18l.com` → 胜出 `reject`；涉及 china, reject
- `DOMAIN-SUFFIX,a5.mzstatic.com` → 胜出 `china`；涉及 china, service
- `DOMAIN-SUFFIX,aa77kk.com` → 胜出 `china`；涉及 china, global
- `DOMAIN-SUFFIX,abbyychina.com` → 胜出 `reject`；涉及 china, reject
- `DOMAIN-SUFFIX,aboutamazon.co.uk` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,aboutamazon.com` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,aboutamazon.com.au` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,aboutamazon.de` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,aboutamazon.es` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,aboutamazon.eu` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,aboutamazon.fr` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,aboutamazon.in` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,aboutamazon.it` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,aboutamazon.jp` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,aboutamazon.pl` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,ac-pocketcamp.com` → 胜出 `gaming`；涉及 gaming, global
- `DOMAIN-SUFFIX,account-paypal.info` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,account-paypal.net` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,account-paypal.org` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,accountpaypal.com` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,accountpaypal.net` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,accountpaypal.org` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,acg.tv` → 胜出 `china`；涉及 china, service
- `DOMAIN-SUFFIX,acgvideo.com` → 胜出 `china`；涉及 china, service
- `DOMAIN-SUFFIX,acmvalidations.com` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,acmvalidationsaws.com` → 胜出 `shopping`；涉及 global, shopping
- `DOMAIN-SUFFIX,acobt.tech` → 胜出 `reject`；涉及 china, reject
- `DOMAIN-SUFFIX,acs.org` → 胜出 `china`；涉及 china, global
- `DOMAIN-SUFFIX,ad7.com` → 胜出 `reject`；涉及 china, reject
- `DOMAIN-SUFFIX,adcdownload.apple.com` → 胜出 `china`；涉及 china, service
